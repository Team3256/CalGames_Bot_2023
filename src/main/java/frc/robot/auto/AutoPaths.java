...
public class AutoPaths {
    ...
    public void sendCommandsToChooser() {
        ...
        Command node6MobilityEngage = autoBuilder.createPath("Node6-Mobility-Engage", kEngagePathConstraints, true);
        AutoChooser.createSinglePath("Node6-Mobility-Engage", node6MobilityEngage);

        Command node5MobilityEngage = autoBuilder.createPath("Node5-Mobility-Engage", kEngagePathConstraints, true); // funny
                                                                                                                     // cube
                                                                                                                     // auto
        AutoChooser.createSinglePath("Node6-Mobility-Engage", node5MobilityEngage);
