        ...
        public void sendCommandsToChooser() {
                ...
                if (swerveSubsystem != null
                        ...
                        autoEventMap.put(
                                        ...
                                        () -> runParallelWithPath(
                                                        Commands.parallel(
                                                                        new StowEndEffector(elevatorSubsystem,
                                                                                        armSubsystem),
                ...
                Command node5x2EngageBottom = autoBuilder.createPath("Node5x2-Engage-Bottom", kEngagePathConstraints,
                                true);
                ...
                Command node6MobilityEngage = autoBuilder.createPath("Node6-Mobility-Engage", kEngagePathConstraints,
                                true);
                AutoChooser.createSinglePath("Node6-Mobility-Engage", node6MobilityEngage);

                Command node5MobilityEngage = autoBuilder.createPath("Node5-Mobility-Engage", kEngagePathConstraints,
                                true); // funny
                // cube
                // auto
                ...
                Command node2Mobility = autoBuilder.createPath("Node2-Mobility", kEngagePathConstraints, true); // funny
                // cube
                // auto
