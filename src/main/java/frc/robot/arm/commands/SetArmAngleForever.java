...
public class SetArmAngleForever extends ProfiledPIDCommand {
   ...
   */
  public SetArmAngleForever(Arm armSubsystem, Rotation2d angleRotation2d) {
    super(
   ...
   * @param armPreset
   */
  public SetArmAngleForever(Arm armSubsystem, ArmPreset armPreset) {
  ...
  public void initialize() {
    ...
    if (AutoConstants.kAutoDebug && false) {
      System.out.println(
          this.getName()
              + " started (preset: "
              + armPreset
