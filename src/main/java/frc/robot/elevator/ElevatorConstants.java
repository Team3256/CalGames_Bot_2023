...
public final class ElevatorConstants {
    ...
    public static final CanDeviceId kElevatorCANDevice = new CanDeviceId(kElevatorMasterID, kElevatorCANBus);
    public static final CanDeviceId kElevatorFollowerCANDevice = new CanDeviceId(kElevatorFollowerID, kElevatorCANBus);

    public static final int kNumElevatorMotors = 2;

    // scoring
    public static final double kConeHighPosition = 1.35; // 1.38
    public static final double kCubeHighPosition = 1.35; // 1.38
    ...
    // Comp: 3.5, 2
    // Tests: 2, 1.5
    public static final TrapezoidProfile.Constraints kElevatorConstraints = new TrapezoidProfile.Constraints(1, 1.5);
    ...
    public static final double kMaxExtension = 1.5; // wrong
